...
#
# 2017 Field Day Stable Release
#

###  To Do List:
###
###  qsos are not dupe checked upon request fills (take first in time.) 
###  Info Table Node "infonode" - For visitors to sign in and report our stats.
###  Re-arrange the code for readability. 
